...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatabaseQuery'
        db.create_table(u'medicine_databasequery', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('query', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'medicine', ['DatabaseQuery'])


    def backwards(self, orm):
        # Deleting model 'DatabaseQuery'
        db.delete_table(u'medicine_databasequery')
    ...
    models = {
        ...
        u'medicine.databasequery': {
            'Meta': {'object_name': 'DatabaseQuery'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
